...
input1 = Input(shape=[28,28,1]) # Sequential 모델의 input_shape랑 같음
Conv2D1 = Conv2D(128,(3,3), strides=2)(input1) #ys1 summary에서 이름이 바뀜
Conv2D2 = Conv2D(filters=64,kernel_size=(3,3), activation='relu')(Conv2D1)
Batch1 = BatchNormalization()(Conv2D2)
drop1 = Dropout(0.3)(Batch1)
Conv2D3 = Conv2D(32,(3,3), activation='relu')(drop1)
Batch2 = BatchNormalization()(Conv2D3)
