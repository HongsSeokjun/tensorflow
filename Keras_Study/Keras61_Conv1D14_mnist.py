...
#2. 모델 구성
model = Sequential()
model.add(Conv1D(256,kernel_size=2, input_shape=(28,28), activation='relu'))
...
import time
start = time.time()
hist = model.fit(x_train,y_train, epochs= 1, batch_size= 256,verbose=2,validation_split=0.05, callbacks=[es])
end = time.time()
#4. 평가 예측
...
#0.98 이상
#cpu
# loss : 0.08539965748786926
# acc : 0.982699990272522
# 시간 : 90.974

# gpu
# loss : 0.08407540619373322
