...
#1. 데이터
path = 'C:\study25ju\_data\kaggle\\bank\\'
...
x_train = x_train.reshape(-1, 10, 1)  # (batch, height, width, channel)
x_test = x_test.reshape(-1, 10, 1)  # (batch, height, width, channel)


#2. 모델구성
model = Sequential()
model.add(Conv1D(32,kernel_size=2,input_shape=(10,1), activation='relu'))
