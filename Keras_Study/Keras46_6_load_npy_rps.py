...
#2. 모델 구성
model = Sequential()
model.add(Conv2D(64,(4,4),input_shape=(150,150,3), activation='relu'))
...
hist = model.fit(x_train,y_train, epochs= 100, batch_size= 32,verbose=2,validation_split=0.1, callbacks=[es,mcp])
#4. 평가 예측
