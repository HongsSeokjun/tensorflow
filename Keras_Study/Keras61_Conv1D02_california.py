...
from tensorflow.keras.layers import Dense, Dropout, BatchNormalization,Conv1D,Flatten,LSTM
...
#2. 모델구성
model = Sequential()
model.add(Conv1D(30,kernel_size=2,input_shape=(8,1), activation='relu'))
