...
#데이터 y값 0과 1의 차이는 133개
augment_size = 133  # 증가시킬 사이즈 
...
x_augmented = datagen.flow(
    ...
    save_to_dir='C:\Study25\_data\_save_img\\07_men_women\\',
    save_prefix='men_women',     # 파일 이름 앞부분 설정 가능
    shuffle=False,
).next()[0]
exit()
...
model = load_model(path+'k46_8_1.hdf5')
...
# loss : 0.40400633215904236
# acc : 0.8028985261917114