...
x_train = x_train.reshape(-1, 93, 1, 1)  # (batch, height, width, channel)
x_test = x_test.reshape(-1, 93, 1, 1)  # (batch, height, width, channel)


#2. 모델구성
model = Sequential()
model.add(Conv2D(32,(1,1),input_shape=(93,1,1), activation='relu'))
