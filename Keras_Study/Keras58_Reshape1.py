...
model = Sequential()
model.add(Dense(100, input_shape=(28,28))) #output 100 => (N,28,100) => 모양을 맞춰 주기 위해 output 맞춰주기
model.add(Reshape(target_shape=(28,10,10))) # (N,28,100) ////// (N,28,280) => (N,28,28,1) 등으로 변형가능
model.add(Conv2D(128,(3,3), strides=1,))#input_shape=(N,28,8,64)))
