...
filename = '{epoch:04d}-{val_loss:.4f}Keras28_MCP_save_09_wine.hdf5'
...
model.fit(x_train,y_train,epochs=300, batch_size=3,verbose=2,validation_split=0.1,callbacks=[es,mcp])
end_time = time.time
#4. 평가,훈련
