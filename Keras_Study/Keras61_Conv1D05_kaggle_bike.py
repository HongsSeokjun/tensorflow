...
#1. 데이터
path = 'C:\study25ju\_data\kaggle\\bike\\' # 상대경로
...
#2. 모델구성
model = Sequential()
model.add(Conv1D(32,kernel_size=2,input_shape=(8,1), activation='relu'))
...
hist = model.fit(x_train, y_train,epochs= 100, batch_size= 20,verbose=2,validation_split=0.1,callbacks=[es])
...
print('result :',result)
print('r2 :',r2)
#r2 : 0.3070682543973079
# r2 : 0.30500311768247734