...
filename = '{epoch:04d}-{val_loss:.4f}Keras28_MCP_save_07_dacondiabetes.hdf5'
...
hist = model.fit(x_train, y_train,epochs= 20, batch_size= 3,verbose=2,validation_split=0.1, callbacks=[es,mcp])
...
#[0.5587865710258484, 0.6818181872367859]
#################### csv파일 만들기 #########################
