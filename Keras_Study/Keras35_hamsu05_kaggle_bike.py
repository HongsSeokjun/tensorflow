...
from tensorflow.keras.models import Sequential,Model # from tensorflow.python.keras.models
from tensorflow.keras.layers import Dense, Dropout,Input #from tensorflow.
...
dense1 = Dense(240, activation='relu')(input1) #ys1 summary에서 이름이 바뀜
...
dense6 = Dense(4,activation='relu')(drop5)
