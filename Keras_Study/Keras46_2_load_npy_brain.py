...
x_train = np.load(np_path+"Keras46_brain_x_train200.npy")
y_train = np.load(np_path+"Keras46_brain_y_train200.npy")
x_test = np.load(np_path+"Keras44_01_x_test200.npy")
y_test = np.load(np_path+"Keras44_01_y_test200.npy")
...
filename = '.hdf5'
filepath = "".join([path,'k46_',filename])
