...
from tensorflow.keras.layers import Dense, Dropout, BatchNormalization,Conv1D,Flatten,Conv2D
...
#2. 모델구성
model = Sequential()
model.add(Conv1D(32,kernel_size=2,input_shape=(8,8), activation='relu'))
...
hist = model.fit(x_train, y_train,epochs= 200, batch_size= 4,verbose=2,validation_split=0.1,class_weight=class_weights,)# callbacks=[mcp])
...
# loss : [0.11162755638360977, 0.9611111283302307]