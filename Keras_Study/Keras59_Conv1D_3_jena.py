...
path = 'C:\study25jun\_data\kaggle\jena\\'
...
# 모델 구조 Conv1D는 무조건 두개이상
model = Sequential([
    Conv1D(100, kernel_size=2, input_shape=(timesteps, x.shape[2])), 
    BatchNormalization(),
    Dropout(0.3),
    Conv1D(50,  kernel_size=2,),
    BatchNormalization(),
    Dropout(0.3),
    Flatten(),
...
# ✅ RMSE: 55.12944209732996 1번의 가중치랑 결과
# ✅ RMSE: 53.97135913871251