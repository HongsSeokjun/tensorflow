...
np.save(np_path+'Keras44_01_x_train100.npy', arr=x)
np.save(np_path+'Keras44_01_y_train100.npy', arr=y)

# np.save(np_path+'Keras44_01_x_test100.npy', arr=x)
# np.save(np_path+'Keras44_01_y_test100.npy', arr=y)

end2 = time.time()

print('걸린 시간 :',round(end2- start2,2),'초') # 걸린 시간 : 414.56 초
exit()
