...
hist = model.fit(x_train,y_train, epochs= 100, batch_size= 20,verbose=2,validation_split=0.05, callbacks=[es,mcp])
...
# loss : 21138.697265625
# R2 : 0.3541257617514918

# loss : 21352.998046875
# R2 : 0.34757800968438557