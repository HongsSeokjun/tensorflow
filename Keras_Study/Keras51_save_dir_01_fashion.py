...
x_augmented = datagen.flow(
    ...
    #save_prefix='fashion',     # 파일 이름 앞부분 설정 가능
).next()[0]
print(x_augmented.shape) #(40000, 28, 28, 1)
print(x_augmented.shape) #(40000, 28, 28, 1)
...
model = load_model(path+'k40_model.h5')
#3. 컴파일, 훈련
...
# gpu Keras39_1_fashion
# acc : 0.9305999875068665


# loss : 0.2191421389579773
