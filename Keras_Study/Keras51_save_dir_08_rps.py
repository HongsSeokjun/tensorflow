...
x_train = np.load(np_path+"Keras46_05_x_train150.npy")
y_train = np.load(np_path+"Keras46_05_y_train150.npy")


# print(x_train.shape, y_train.shape)  #(2048, 150, 150, 3) (2048, 3)

augment_size = 500  # 증가시킬 사이즈 
...
x_augmented = datagen.flow(
    ...
    # save_to_dir='C:\Study25\_data\_save_img\\08_rps\\',
    # save_prefix='rps',     # 파일 이름 앞부분 설정 가능
    shuffle=False,
).next()[0]
...
model = load_model(path+'k46_6.hdf5')
...
hist = model.fit(x_train,y_train, epochs= 100, batch_size= 32,verbose=2,validation_split=0.1, callbacks=[es])
#4. 평가 예측
...
images = x_test.reshape(-1, 150, 150,3)
...
# loss : 0.1963002234697342
# acc : 0.8941176533699036